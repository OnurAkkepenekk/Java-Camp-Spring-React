...
public class ProductManager implements ProductService {
	...
	@Override
	public DataResult<List<Product>> getByProductNameOrCategoryId(String productName, String categoryId) {
	...
	public DataResult<List<Product>> getByNameAndCategory(String productName, int category) {
		return new SuccessDataResult<List<Product>>(this.productDao.getByNameAndCategory(productName, category),
				"Data listelendi.");
	}
